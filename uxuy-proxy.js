...
async function main() {
  ...
  console.log("This Tool Is Developed By Zain Please Suppot Join Our Channel (https://t.me/AirdropScript6)".yellow);
  ...
  while (true) {
    ...
    await sleep(3);
    console.log(" This Tool Is Developed By Zain Arain Please Suppot Join Our Channel (https://t.me/AirdropScript6)".yellow);
